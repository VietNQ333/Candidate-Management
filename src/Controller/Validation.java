...
public class Validation {
    ...
    private static final String phoneValid = "^\\d{10}\\d*$";
    ...
    public static int checkInputExprience(int birthDate) {
        ...
        while (true) {
            ...
            if (yearExperience > age +16) {
                System.err.println("Experience must be smaller than age + 16");
            } else {
    ...
    public static int checkInputExperience(Date birthDate) {
